...
# t_max = 2*3600.0 # shorter for testing (remember to change t_start, t_end, Σ_t_start, Σ_t_end in get_reference_config()
# use_ramp = true
# if use_ramp
...
function get_reference_config(::SOCRATES_Train)
    ...
    local_namelist_here = [
        ...
        ("user_args", (;use_supersat=true) ) # we need supersat for non_eq results and the ramp for eq
        ] 
