#!/bin/bash
run_calibrated_script=~/Research_Schneider/CliMa/CalibrateEDMF.jl/experiments/SOCRATES_Calibrate_exponential_T_scaling/julia_parallel/run_calibrated_script # update these to work form anywhere so can use HPC too... see start_calibration.sh
