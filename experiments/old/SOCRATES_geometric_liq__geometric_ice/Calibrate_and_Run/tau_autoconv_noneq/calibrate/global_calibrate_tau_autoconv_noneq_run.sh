...
experiment_name=geometric_liq__geometric_ice
calibrate_script=~/Research_Schneider/CliMa/CalibrateEDMF.jl/experiments/SOCRATES_${experiment_name}/global_parallel/ekp_par_calibration.sbatch
experiment_path=~/Research_Schneider/CliMa/CalibrateEDMF.jl/experiments/SOCRATES_${experiment_name}/
