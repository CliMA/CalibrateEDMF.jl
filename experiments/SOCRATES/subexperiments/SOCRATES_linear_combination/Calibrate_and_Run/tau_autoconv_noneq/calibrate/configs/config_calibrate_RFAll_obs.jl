...
calibration_parameters_default = Dict( # The variables we wish to calibrate , these aren't in the namelist so we gotta add them to the local namelist...
    ...
    "linear_combination_liq_c_3"   => Dict("prior_mean" => FT(-1e-10)                        , "constraints" => bounded_above(0) , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing), # asssume nothing here? (keep 0 as upper bound?) not sure it can actually equal 0 with that though...
    # "linear_combination_liq_c_4"   => Dict("prior_mean" => FT(N_l * r_0)                    , "constraints" => bounded_below(0) , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing), 
    #
    ...
    # "linear_combination_ice_c_4"   => Dict("prior_mean" => FT(N_l * r_0)                    , "constraints" => bounded_below(0) , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing), 
    #
