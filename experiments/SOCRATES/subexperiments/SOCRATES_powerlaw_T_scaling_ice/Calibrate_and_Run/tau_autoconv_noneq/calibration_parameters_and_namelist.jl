...
calibration_parameters__experiment_setup = Dict( # The variables we wish to calibrate , these aren't in the namelist so we gotta add them to the local namelist...
    ...
    "powerlaw_T_scaling_ice_c_1" => Dict(
        "prior_mean" => global_param_defaults["powerlaw_T_scaling_ice_c_1"]["prior_mean"],
        "constraints" => global_param_defaults["powerlaw_T_scaling_ice_c_1"]["constraints"],
        "l2_reg" => nothing,
        "CLIMAParameters_longname" => nothing,
        "unconstrained_σ" => global_param_defaults["powerlaw_T_scaling_ice_c_1"]["unconstrained_σ"],
    ),
    "powerlaw_T_scaling_ice_c_2" => Dict(
        "prior_mean" => global_param_defaults["powerlaw_T_scaling_ice_c_2"]["prior_mean"],
        "constraints" => global_param_defaults["powerlaw_T_scaling_ice_c_2"]["constraints"],
        "l2_reg" => nothing,
        "CLIMAParameters_longname" => nothing,
        "unconstrained_σ" => global_param_defaults["powerlaw_T_scaling_ice_c_2"]["unconstrained_σ"],
    ),
)
...
local_namelist__experiment_setup = [ # things in namelist that otherwise wouldn't be... (both random parameters and parameters we want to calibrate that we added ourselves that generate_namelist doesn't insert...)
    ...
    (
        ...
        calibration_parameters__experiment_setup["powerlaw_T_scaling_ice_c_1"]["prior_mean"],
    ),
    (
        "user_aux",
        "powerlaw_T_scaling_ice_c_2",
        calibration_parameters__experiment_setup["powerlaw_T_scaling_ice_c_2"]["prior_mean"],
    ),
    #
]
