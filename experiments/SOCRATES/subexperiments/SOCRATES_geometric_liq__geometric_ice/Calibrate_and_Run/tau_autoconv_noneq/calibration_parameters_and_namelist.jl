...
calibration_parameters__experiment_setup = Dict( # The variables we wish to calibrate , these aren't in the namelist so we gotta add them to the local namelist...
    ...
    #
    "geometric_ice_c_1" => Dict("prior_mean" => global_param_defaults["geometric_ice_c_1"]["prior_mean"], "constraints" => global_param_defaults["geometric_ice_c_1"]["constraints"] , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing, "unconstrained_σ" => global_param_defaults["geometric_ice_c_1"]["unconstrained_σ"]),
    "geometric_ice_c_2" => Dict("prior_mean" => global_param_defaults["geometric_ice_c_2"]["prior_mean"], "constraints" => global_param_defaults["geometric_ice_c_2"]["constraints"] , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing, "unconstrained_σ" => global_param_defaults["geometric_ice_c_2"]["unconstrained_σ"]),
    "geometric_ice_c_3" => Dict("prior_mean" => global_param_defaults["geometric_ice_c_3"]["prior_mean"], "constraints" => global_param_defaults["geometric_ice_c_3"]["constraints"] , "l2_reg" => nothing, "CLIMAParameters_longname" => nothing, "unconstrained_σ" => global_param_defaults["geometric_ice_c_3"]["unconstrained_σ"]),
    #
) 
