...
function get_output_config()
    config = Dict()
    config["outdir_root"] = joinpath(experiment_dir, "Calibrate_and_Run","tau_autoconv_noneq", "calibrate", "output", calibrate_to, "RF09_obs") # store them in the experiment folder here by default
