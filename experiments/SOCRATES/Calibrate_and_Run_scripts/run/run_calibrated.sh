...
run_calibrated_script=~/Research_Schneider/CliMa/CalibrateEDMF.jl/experiments/${experiment}/julia_parallel/run_calibrated_script # update these to work form anywhere so can use HPC too... see start_calibration.sh
experiment_path=~/Research_Schneider/CliMa/CalibrateEDMF.jl/experiments/${experiment}/
