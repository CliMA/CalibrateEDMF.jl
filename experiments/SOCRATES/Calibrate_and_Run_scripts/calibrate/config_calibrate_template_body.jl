...
calibration_setup = "TBD"
# calibrate_to
calibrate_to = "TBD" # "Atlas_LES" or "Flight_Observations"
# SOCRATES setups
flight_numbers = Vector{Int}() # a list of some sort
# pad flight number to two digit string if is 1 digit
forcing_types  = Vector{Symbol}()
...
# ========================================================================================================================= #
calibration_vars = Vector{String}() # TBD will fill in later
# ========================================================================================================================= #
# ========================================================================================================================= #
