...
function get_output_config()
    config = Dict()
    config["outdir_root"] = joinpath(experiment_dir, "Calibrate_and_Run","pow_icenuc_autoconv_eq", "calibrate", "output", calibrate_to, "RF09_obs") # store them in the experiment folder here by default
