...
# Calibrate τ + autoconv params | eq
clear; sbatch -o ${log_dir}/calibrate_RF01_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF01_obs.jl 
clear; sbatch -o ${log_dir}/calibrate_RF09_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF09_obs.jl
clear; sbatch -o ${log_dir}/calibrate_RF10_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF10_obs.jl
clear; sbatch -o ${log_dir}/calibrate_RF11_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF11_obs.jl
clear; sbatch -o ${log_dir}/calibrate_RF12_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF12_obs.jl
clear; sbatch -o ${log_dir}/calibrate_RF13_obs.out  $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RF13_obs.jl
clear; sbatch -o ${log_dir}/calibrate_RFAll_obs.out $calibrate_script  ${this_config_dir}/run_calibrated_${this_config}_RFAll_obs.jl
