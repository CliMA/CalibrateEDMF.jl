...
for flight_number in flight_numbers
    ...
    if setup_environment
        ...
        namelist["time_stepping"]["dt_min"] = 5.0
        namelist["time_stepping"]["dt_max"] = 20.0
        ...
        namelist["grid"]["dz_min"] = 10.0 * (namelist["time_stepping"]["dt_min"] / 0.5)
        namelist["time_stepping"]["spinup_adapt_dt"] = false
    ...
    # ========================================================================================================================= #
        ...
        # namelist["user_aux"]["T_scaling_ice_c_1"] = 0.0013737960245654272
        # namelist["user_aux"]["T_scaling_ice_c_2"] = -2.6671518848963918
        ...
        namelist["user_aux"]["T_scaling_ice_c_2"] = 7
        ...
        namelist["user_args"] = (; use_supersat = supersat_type,
            ...
            sedimentation_ice_number_concentration = supersat_type,
        ...
        # namelist["user_aux"]["min_τ_liq"] = 1.0
        # namelist["user_aux"]["min_τ_ice"] = 1.0
