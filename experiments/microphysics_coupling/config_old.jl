...
function get_process_config()
    ...
    config["N_ens"] = 59 # Must be 2p+1 when algorithm is "Unscented"
...
function get_prior_config()
    ...
    config["constraints"] = Dict(
        ...
        "microph_scaling" => [bounded(0.0, 2.0)],
        "microph_scaling_dep_sub" => [bounded(0.0, 2.0)],
        "microph_scaling_melt" => [bounded(0.0, 2.0)],
        "E_liq_rai" => [bounded(0.0, 2.0)],
        "E_liq_sno" => [bounded(0.0, 2.0)],
        "E_ice_rai" => [bounded(0.0, 2.0)],
        "E_ice_sno" => [bounded(0.0, 2.0)],
        "E_rai_sno" => [bounded(0.0, 2.0)],
    )
